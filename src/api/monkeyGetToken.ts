...
import cardDetailJson from "../mokeup/cardDetail.json";
import favorListJson from "../mokeup/favorList.json";
import suggestCardJson from "../mokeup/suggestCard.json";
